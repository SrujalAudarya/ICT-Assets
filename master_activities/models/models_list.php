        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input
                    ...
                    name="search"
                    class="form-control"
                    placeholder="Search by Model Name, Category or Vendor..."
            ...
            <div class="col-md-3">
                ...
                <a href="models_list.php" class="btn btn-secondary">
                    Reset
                </a>
                        ...
                        <?php while($row = mysqli_fetch_assoc($result)): ?>
                            ...
                            <tr>
                                ...
                                <td class="fw-bold">
                                    ...
                                    <a
                                      href="models_details.php?id=<?= $row['model_id'] ?>"
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <a
                                          href="<?= ROUTE_MODELS_EDIT ?>?id=<?= $row['model_id'] ?>"
                                        ...
                                        <a
                                          href="<?= ROUTE_MODELS_DELETE ?>?id=<?= $row['model_id'] ?>"
