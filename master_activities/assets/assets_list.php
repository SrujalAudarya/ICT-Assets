...
/* =========================================================
   FILTERS & LIFECYCLE RESTRICTIONS
   ========================================================= */
                            ...
                            <?php if ($result && mysqli_num_rows($result) > 0): ?>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $status_n = $row['status_name'] ?? 'N/A';
                                            $badge_class = 'bg-secondary';
                                            $status_icon = '';

                                            if ($status_n == 'Assigned') { 
                                                $badge_class = 'bg-primary'; 
                                                $status_icon = '<i class="bi bi-person-check-fill me-1"></i>'; 
                                            } elseif ($status_n == 'Available') { 
                                                $badge_class = 'bg-success'; 
                                                $status_icon = '<i class="bi bi-check-circle-fill me-1"></i>'; 
                                            } elseif ($status_n == 'Working') { 
                                                $badge_class = 'bg-success border border-success bg-opacity-75 text-white'; 
                                                $status_icon = '<i class="bi bi-activity me-1"></i>'; 
                                            } elseif ($status_n == 'Under Repair') { 
                                                $badge_class = 'bg-warning text-dark'; 
                                                $status_icon = '<i class="bi bi-tools me-1"></i>'; 
                                            ...
                                            } elseif (in_array($status_n, ['Retired', 'Condemned'])) { 
                                                $badge_class = 'bg-danger'; 
                                                $status_icon = '<i class="bi bi-trash-fill me-1"></i>'; 
                                            }
                                            ?>
                                            <span class="badge <?= $badge_class ?> rounded-pill mb-1 d-inline-block px-3 py-2 shadow-sm">
